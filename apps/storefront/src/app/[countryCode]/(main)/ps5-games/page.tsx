...
export const metadata: Metadata = {
  title: "بازی‌های PS5 | گیمینت",
  description: "بزرگ‌ترین مجموعه‌ی بازی‌های PS5 در گیمینت، با ضمانت اصالت و پشتیبانی کامل",
}

export default async function PS5GamesPage({
  params,
}: {
      ...
      <div className="mx-auto w-full max-w-[1480px] px-4 sm:px-6 lg:px-8">
        ...
        <section className="mt-12">
          <div className="mb-5">
            ...
            <h2 className="text-xl font-black text-white sm:text-2xl">بازی‌های PS5 موجود</h2>
          </div>
          {games.length > 0 ? (
