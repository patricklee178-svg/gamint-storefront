...
const slides: HeroSlide[] = [
  ...
  },
  {
    ...
    title: "UFC",
    accent: "6",
    accentClass: "from-red-500 via-orange-400 to-yellow-300",
    description: "دقیق‌ترین شبیه‌سازی مبارزات اوکتاگون با فناوری Sapien؛ حالا با کراس‌پلی کامل بین کنسول‌ها.",
    badges: ["تحویل فوری", "نسخه PS5", "ضمانت اصالت"],
    primaryLabel: "پیش‌خرید UFC 6",
    secondaryLabel: "دیدن تریلر بازی",
  },
  {
    id: "nba2k27",
    ...
    title: "NBA",
    accent: "2K27",
    accentClass: "from-red-500 via-orange-400 to-blue-400",
    description: "فیزیک واقعی‌تر با ProPLAY و حرکاتی مستقیم از زمین مسابقه؛ رویای NBA حالا واقعی‌تر از همیشه.",
    badges: ["تحویل فوری", "نسخه PS5", "ضمانت اصالت"],
    primaryLabel: "پیش‌خرید NBA 2K27",
    secondaryLabel: "دیدن تریلر بازی",
  },
  {
    id: "bond-first-light",
    ...
    title: "007",
    accent: "First Light",
    accentClass: "from-amber-300 via-yellow-400 to-amber-600",
    description: "آغاز داستان جیمز باند جوان؛ ترکیبی از اکشن سینمایی و مخفی‌کاری استادانه از سازندگان Hitman.",
    badges: ["دانلود روز انتشار", "نسخه PS5", "پشتیبانی ۲۴/۷"],
    primaryLabel: "پیش‌خرید 007: First Light",
    secondaryLabel: "دیدن تریلر بازی",
  },
  {
    id: "re-requiem",
    ...
    title: "Resident Evil",
    accent: "Requiem",
    accentClass: "from-rose-500 via-red-600 to-red-900",
    description: "بازگشت به راکون‌سیتی نفرین‌شده؛ ترسناک‌ترین فصل سری رزیدنت اویل به‌زودی از راه می‌رسد.",
    badges: ["دانلود روز انتشار", "نسخه PS5", "ضمانت اصالت"],
    primaryLabel: "پیش‌خرید Resident Evil Requiem",
    secondaryLabel: "دیدن تریلر بازی",
  },
]
