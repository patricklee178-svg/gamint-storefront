// Auto-generated from password-reset.html — do not edit the .html separately, keep them in sync.
export const html = `
<!DOCTYPE html>
...
<title>بازیابی رمز عبور گیمینت</title>
</head>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#05070b;">
  <tr>
    <td align="center" style="padding:40px 16px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background-color:#0a0d14; border:1px solid #1c1f2a; border-radius:20px; overflow:hidden;">
        ...
        <tr>
          <td align="center" style="padding:32px 32px 8px 32px;">
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="width:64px; height:64px; background-color:rgba(124,58,237,0.12); border:1px solid rgba(124,58,237,0.4); border-radius:999px; font-size:28px; line-height:64px;">
                  🔒
                </td>
              </tr>
            </table>
            <p style="margin:20px 0 0 0; color:#ffffff; font-size:20px; font-weight:bold; line-height:1.6;">
              درخواست بازیابی رمز عبور
            </p>
            <p style="margin:12px 0 0 0; color:#9ca3af; font-size:14px; line-height:1.9;">
              سلام {{customer_name}}، یه درخواست برای تغییر رمز عبور حساب گیمینت‌ت ثبت شده. با کلیک روی دکمه‌ی زیر رمز جدید تنظیم کن.
            </p>
          </td>
        </tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background-color:#7c3aed; background-image:linear-gradient(135deg, #7c3aed, #d946ef); border-radius:12px;">
                  <a href="{{reset_url}}" style="display:inline-block; padding:14px 40px; color:#ffffff; font-size:14px; font-weight:bold; text-decoration:none;">تنظیم رمز جدید</a>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td align="center" style="padding:16px 32px 0 32px;">
            <p style="margin:0; color:#6b7280; font-size:12px; line-height:1.8;">
              این لینک تا ۳۰ دقیقه دیگه معتبره. اگه این درخواست از طرف تو نبوده، نیازی به هیچ کاری نیست — رمز عبورت همچنان امنه.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:24px 32px;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center" style="width:33%; color:#9ca3af; font-size:11px; padding:0 4px;">🛡️<br /><span style="color:#e5e7eb; font-weight:bold; font-size:11px;">خرید امن</span></td>
