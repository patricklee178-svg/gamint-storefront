// Auto-generated from welcome.html — do not edit the .html separately, keep them in sync.
export const html = `
<!DOCTYPE html>
...
<title>به گیمینت خوش اومدی</title>
</head>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#0a0d14; border:1px solid #1c1f2a; border-radius:20px; overflow:hidden;">
        ...
        <tr>
          <td align="center" style="padding:36px 32px 24px 32px;">
            <img src="https://gamint.ir/gamint-logo-email.png" width="150" alt="گیمینت" style="display:block; border:0;" />
          </td>
        </tr>
        ...
        <tr>
          <td align="center" style="padding:32px 32px 8px 32px;">
            <p style="margin:0; color:#ffffff; font-size:23px; font-weight:bold; line-height:1.6;">
              به خانواده‌ی گیمینت خوش اومدی، {{customer_name}} 🎉
            </p>
            <p style="margin:14px 0 0 0; color:#9ca3af; font-size:14px; line-height:1.9; max-width:420px;">
              حساب کاربریت با موفقیت ساخته شد. حالا می‌تونی به بزرگ‌ترین کاتالوگ بازی‌های PS5 و PS4، پیش‌فروش‌ها، گیفت‌کارت و اشتراک پلی‌استیشن دسترسی داشته باشی.
            </p>
          </td>
        </tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background-color:#7c3aed; background-image:linear-gradient(135deg, #7c3aed, #d946ef); border-radius:12px;">
                  <a href="https://gamint.ir/categories/games" style="display:inline-block; padding:14px 40px; color:#ffffff; font-size:14px; font-weight:bold; text-decoration:none;">مشاهده فروشگاه</a>
                </td>
              </tr>
            </table>
          </td>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td width="50%" style="padding:0 6px 12px 0;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#0d1017; border:1px solid #1c1f2a; border-radius:12px;">
                    <tr><td style="padding:16px;">
                      <span style="font-size:18px;">🎮</span>
                      <p style="margin:8px 0 0 0; color:#e5e7eb; font-size:12.5px; font-weight:bold;">پیش‌فروش بازی‌ها</p>
                      <p style="margin:4px 0 0 0; color:#6b7280; font-size:11px;">تازه‌ترین عناوین رو زودتر تهیه کن</p>
                    </td></tr>
                  </table>
                </td>
                <td width="50%" style="padding:0 0 12px 6px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#0d1017; border:1px solid #1c1f2a; border-radius:12px;">
                    <tr><td style="padding:16px;">
                      <span style="font-size:18px;">🎁</span>
                      <p style="margin:8px 0 0 0; color:#e5e7eb; font-size:12.5px; font-weight:bold;">گیفت‌کارت PSN</p>
                      <p style="margin:4px 0 0 0; color:#6b7280; font-size:11px;">تحویل آنی، تمام مبالغ</p>
                    </td></tr>
                  </table>
                </td>
              </tr>
              <tr>
                <td width="50%" style="padding:0 6px 0 0;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#0d1017; border:1px solid #1c1f2a; border-radius:12px;">
                    <tr><td style="padding:16px;">
                      <span style="font-size:18px;">💎</span>
                      <p style="margin:8px 0 0 0; color:#e5e7eb; font-size:12.5px; font-weight:bold;">اشتراک PS Plus</p>
                      <p style="margin:4px 0 0 0; color:#6b7280; font-size:11px;">بازی آنلاین و کتابخونه‌ی بزرگ</p>
                    </td></tr>
                  </table>
                </td>
                <td width="50%" style="padding:0 0 0 6px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#0d1017; border:1px solid #1c1f2a; border-radius:12px;">
                    <tr><td style="padding:16px;">
                      <span style="font-size:18px;">👥</span>
                      <p style="margin:8px 0 0 0; color:#e5e7eb; font-size:12.5px; font-weight:bold;">اکانت ظرفیتی</p>
                      <p style="margin:4px 0 0 0; color:#6b7280; font-size:11px;">قیمت مقرون‌به‌صرفه‌تر</p>
                    </td></tr>
                  </table>
                </td>
              </tr>
