        ...
        <tr>
          <td align="center" style="padding:32px 32px 8px 32px;">
            <table role="presentation" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background-color:rgba(124,58,237,0.12); border:1px solid rgba(124,58,237,0.35); border-radius:999px; padding:6px 16px;">
                  <span style="color:#c4b5fd; font-size:12px; font-weight:bold;">کد ورود یک‌بار مصرف</span>
                </td>
              </tr>
            </table>
          </td>
